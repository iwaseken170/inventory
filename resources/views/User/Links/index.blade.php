                            ...
                            @foreach($link as $key => $links)
                                <tr id="links{{$links->id}}">
                                    ...
                                    <td style="text-align: center; vertical-align:middle;width:190px">
                                        ...
                                        <button class="btn btn-danger btn-delete-link btn-mini btn-delete-file" data-id="{{$links->id}}"><i class="icon-trash"></i> Del</button>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $('tbody').delegate('.btn-delete-link','click',function(){
            var value = $(this).data('id');
            var url = '{{URL::to('manage/deleteLink')}}';
